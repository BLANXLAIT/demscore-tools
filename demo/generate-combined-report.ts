...
if (viewsRows.length === 0) {
    console.log("No VIEWS data returned. Exiting.");
    process.exit(0);
}
...
<div class="container">
  ...
  <div class="footer">
    Generated by
    <a href="https://github.com/blanxlait/demscore-tools" target="_blank" rel="noopener noreferrer">@demscore/ucdp</a> +
    <a href="https://github.com/blanxlait/demscore-tools" target="_blank" rel="noopener noreferrer">@demscore/views</a> SDKs
    &middot;
    UCDP data from <a href="https://ucdp.uu.se" target="_blank" rel="noopener noreferrer">Uppsala Conflict Data Program</a>
    &middot;
    VIEWS data from <a href="https://viewsforecasting.org" target="_blank" rel="noopener noreferrer">VIEWS Forecasting</a> (PRIO)
    ...
    <div class="citations">
      ...
      <p>UCDP is part of and funded by <a href="https://demscore.com" target="_blank" rel="noopener noreferrer">DEMSCORE</a>, national research infrastructure grant 2021-00162 from the Swedish Research Council.</p>
      <p style="margin-top: 0.75rem"><strong>VIEWS:</strong></p>
      <p>The Violence &amp; Impacts Early-Warning System (VIEWS) is developed by the Department of Peace and Conflict Research, Uppsala University, and the Peace Research Institute Oslo (PRIO). VIEWS data is open access. See <a href="https://viewsforecasting.org" target="_blank" rel="noopener noreferrer">viewsforecasting.org</a> for methodology.</p>
    </div>
  </div>
